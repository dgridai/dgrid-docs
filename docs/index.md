...
hero:
  name: "DGrid AI"
  text: "The Decentralized Smart Network of AI"
  image: 
    src: /DGrid.png
    alt: Dgrid.ai
  actions:
    ...
    - theme: alt
      ...
      link: What-we-do
    - theme: alt
      text: DGrid's Solution
      link: DGrids-Solution
    
features:
  - title: AI Gateway
    details: A Web3-native gateway to 200+ leading AI models through a single API. Significantly cut integration costs by using your own keys with tools like Claude Code and Moltbot.
    link: '/AI-Gateway'
  - title: AI Arena
    details: A gamified platform for anonymous, blind AI model battles. Your votes provide real preference data that continuously trains our intelligent routing algorithms — making the network smarter with every interaction.
    link: '/AI-Arena'
  - title: Dori
